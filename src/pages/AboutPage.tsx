        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-up">
            ...
            <div className="flex flex-col gap-4 font-body text-sm text-[hsl(var(--muted-foreground))] leading-relaxed">
              <p>UZOR родился в 2018 году как ответ на запрос рынка в подлинной элегантности. Наш основатель провёл 12 лет в модных домах Милана и Парижа, прежде чем решил создать бренд, который объединит западную утончённость с богатым наследием русского орнаментального искусства.</p>
              <p>Каждая коллекция UZOR — это месяцы работы: от выбора тканей у итальянских производителей до финальной примерки в нашем ателье в Москве.</p>
              <p>Мы верим, что истинная роскошь — это не логотипы и не ценники. Это ощущение, которое вы испытываете, когда надеваете что-то по-настоящему совершенное.</p>
            </div>
          </div>
      ...
      <section className="py-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {[
            ...
            { num: "47", label: "Этапов контроля" },
            { num: "12K+", label: "Клиентов" },
            { num: "8", label: "Наград дизайна" },
          ].map(item => (
